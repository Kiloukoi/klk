...
-- Create message status function
...
DECLARE
  ...
  v_total_price text;
BEGIN
  SELECT l.title, p.username 
  INTO v_listing_title, v_sender_username
  FROM listings l
...
CREATE INDEX IF NOT EXISTS messages_listing_participants_idx 
